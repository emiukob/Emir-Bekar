...
// =====================================================================
const int MY_ROBOT_ID = 3; // Bu robotun kimliği (Takipçi 3)

// Hız Denkleştirme: Motorlar çok hızlıysa düşür, yavaşsa artır.
// R3 OLCULDU: ayni komutta digerlerinden ~%40 yavas (motor/batarya) ->
// 0.65 ile telafi (PC tarafindaki trim kaldirildi). Hala yavassa 0.70 yap,
// fazla hizliysa 0.60'a indir.
const float HIZ_CARPANI = 0.65; // R3: guclendirilmis
